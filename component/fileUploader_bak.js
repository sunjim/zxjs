                ...
                if (res.code == 0) {
                    ...
                    $(res.data).each(function (i) {
                        if(res.data[i]['type']=='dir'){
                            html += '<li class="mb-2" style="background-color: transparent;border:none;" type="dir" title="'+res.data[i]['name']+'"><i class="ion ion-folder" style="font-size:98px;color:#ff7800;" ></i><span>'+res.data[i]['name']+'</span></li>';
                        }else{
