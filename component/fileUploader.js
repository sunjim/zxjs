define([
    ...
    let obj = {
        options: {},
        //加载远程图片
        getImageList: function (url,name=null) {
                ...
                if(res.status==200){
                    ...
                    if(res.data.length>0){
                        res.data.forEach((item,index)=>{
                            'use strict';
                            if(item.type=='dir'){
                                html += '<li class="mb-2" style="background-color: transparent;border:none;" type="dir" title="'+item.name+'"><i class="ion ion-folder" style="font-size:98px;color:#ff7800;" ></i><span>'+item.name+'</span></li>';
                            }else{
                                html += '<li style="background-image: url(' + item.path + ');" path="' + item.path + '"></li>';
                            }
                        })
                    }
                    html += "</ul>";
                    ...
                    modalobj = modal({
                        ...
                        events: {
                            'shown.bs.modal': function () {
                                ...
                                obj.getImageList(zxjs.filesLists);
                                //分页处理
                                ...
                                modalobj.delegate('#imagelists li', 'click', function () {
                                    ...
                                    if(type=='dir'){
                                        ...
                                        obj.getImageList(zxjs.filesLists,title);
                                    }else{
                                        $(this).toggleClass('selectActive');
                                        images = [];
                    ...
                    modalobj = modal({
                        ...
                        events: {
                            'shown.bs.modal': function () {
                                ...
                                getImageList(zxjs.filesLists + '&type=file');
                                //分页处理
                                modalobj.delegate('#imagelists .pagination a', 'click', function () {
        ...
        initImageUploader: function (options) {
            ...
            if (!WebUploader.Uploader.support('flash') && WebUploader.browser.ie) {
                ...
                if (flashVersion) {
                    (function (container) {
                        ...
                        //zxjs.base + '/package/webuploader/dist/Uploader.swf',
                        var swf = 'resource/zxjs/component/webuploader/expressInstall.swf';
                        // insert flash object
            ...
            var _options = $.extend({
                ...
                dnd: '#dndArea',
                paste: '#uploader',
                swf: zxjs.base + '/package/webuploader/dist/Uploader.swf',
                chunked: false,
                chunkSize: 512 * 1024,
                server: zxjs.uploader,
                // runtimeOrder: 'flash',
